	...
	<PageMargin>
		...
		>
			Note: <strong style={{
				...
				fontWeight: '900'
			}}>This is pre-release software.</strong> While we believe it to be correct to the best of our
			knowledge, we make no warraties about accuracy, quality or fitness for any purpose. Please use with discretion. If
