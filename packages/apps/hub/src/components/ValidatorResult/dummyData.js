export const dummyData = {
	...
	tests: [
		...
		},
		{
			...
			endpoint: '/services',
			description:
				'Does the services list endpoint return a paginated list of services in the correct schema',
			success: false,
			issues: [
				{
					name: 'required',
		...
		},
		{
			...
			description:
				'Does the service by id endpoint return a fully nested service in the correct schema',
			success: false,
			issues: [
				{
					name: 'required',
		...
		},
		{
			...
			endpoint: '/taxonomies',
			description:
				'Does the taxonomies list endpoint return a paginated list of taxonomies in the correct schema',
			success: true,
			issues: []
		},
		{
			...
			description:
				'Does the taxonomy by id endpoint return the full information of a taxonomy in the correct schema',
			success: false,
			issues: [
				{
					name: 'required',
		...
		},
		{
			...
			description:
				'Does the taxonomy terms list endpoint return a paginated list of taxonomy terms in the correct schema',
			success: true,
			issues: []
		},
		{
			...
			description:
				'Does the taxonomy term by id endpoint return the full information of a taxonomy term in the correct schema',
			success: false,
			issues: [
				{
					name: 'required',
		...
		},
		{
			...
			description:
				'Does the service at location list endpoint return a paginated list of services at locations in the correct schema',
			success: false,
			issues: [
				{
					name: 'required',
		...
		},
		{
			...
			description:
				'Does the service at location by id endpoint return the full information of a service at location in the correct schema',
			success: false,
			issues: [
				{
					name: 'required',
