...
import logo from './how-to-get-started.webp'
...
export default async function Page() {
	const { data, content } = await getMarkdownData('adopt/practical-examples', 'page-1')
	...
	return (
		<section>
			<Columns layout='42' className={undefined} debug={undefined} supressTrailingSpace={undefined}>
				...
				<div>
					<Image src={logo} alt='How to get started' width={200} />
				</div>
			</Columns>
