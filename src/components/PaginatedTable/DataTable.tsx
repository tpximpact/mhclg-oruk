...
const Table = ({ children, className = '', ...props }: { children: ReactNode; className?: string; [key: string]: any }) => (
	<div role='table' className={`${styles.table} ${className}`} {...props}>
		{children}
	</div>
)
const Thead = ({ children, className = '', ...props }: { children: ReactNode; className?: string; [key: string]: any }) => (
	<div role='rowgroup' className={`${styles.thead} ${className}`} {...props}>
		{children}
	</div>
)
const Tbody = ({ children, className = '', ...props }: { children: ReactNode; className?: string; [key: string]: any }) => (
	<div role='rowgroup' className={`${styles.tbody} ${className}`} {...props}>
		{children}
	</div>
)
const Tr = ({ children, className = '', ...props }: { children: ReactNode; className?: string; [key: string]: any }) => (
	<div role='row' className={`${styles.tr} ${className}`} {...props}>
		{children}
	</div>
)
const Th = ({ children, className = '', column, ...props }: { children: ReactNode; className?: string; column?: string; [key: string]: any }) => (
	<div
...
const Td = ({ children, className = '', ...props }: { children: ReactNode; className?: string; [key: string]: any }) => (
	<div role='cell' className={`${styles.td} ${className}`} {...props}>
		{children}
	</div>
)

const getCellClassFordataType = (dataType: string): string | null => {
	switch (dataType) {
