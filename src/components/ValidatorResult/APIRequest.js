...
export const APIRequest = ({ src, exampleId, apiPath }) => {
...
const buildIDQueryString = ({ baseURL, path, idValue }) =>
...
const ParametersWidgetID = ({ baseURL, path, status, dispatchRequest, initialIDValue }) => {
